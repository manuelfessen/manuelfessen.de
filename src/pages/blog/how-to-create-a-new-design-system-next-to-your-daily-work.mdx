...
# Introduction
In this case study, I aim to impart my knowledge and experiences on how to establish a new design system while maintaining one's daily responsibilities. This guide is particularly helpful for those who may not have the luxury of dedicating a significant amount of time to this task.  <br />  <br />
I present the process in an autobiographical manner, supplementing it with the **lessons** we have learned along the way. You may choose to skip our errors and make use of our best practices, or you may opt to go straight to the [TLDR](#tldr) for a short version of the learnings and to [Submissions](##Submissions) for my screens. However, please keep in mind that doing so will mean missing out on the contextual background.
...
# Design challenge
After this work was done we finally started the design challenge. In this challenge we **built a (self-proclaimed) Chinese wall**.  <br />  <br />
...
We reviewed all the designs and tried to **merge the best ideas.** As a solution to this challenge, we tested the different designs with users and some of the stakeholders. After the testing we improved the most successful design with the ideas of the other designers. <br />  <br />
