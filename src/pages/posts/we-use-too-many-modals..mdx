...
title: Modals everywhere
publishDate: 11.02.2022
description: Why I publicly lobby against modals, let's just not overuse them. It's bad ux, there are better options. 
tags: ["opinion", "ux"]
keywords: UX / Opinion
hero: "../images/blog/modals-meme.webp"
---
<img src="/images/blog/modals-meme.webp" alt="meme about modals"/>
# Lets just not
...
- Escape or clicking outside the modal should close the window
