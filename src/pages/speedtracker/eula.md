...
Users are responsible for the accuracy, legality, and proper use of the App, especially when operating a vehicle.

We explicitly do not guarantee the legal, factual accuracy, or reliability of the App's speed measurements, distance calculations, or other metrics.
...
- Use the App while operating a vehicle in an unsafe manner or in violation of local traffic laws.
- Rely on the App as a replacement for official speedometers or navigation systems.
- Use the App for tracking individuals without their express consent.
- Use the App to enable or facilitate reckless driving, street racing, or other dangerous activities.
...
The App utilizes device location services, GPS data, and motion sensors to track speed, distance, routes, and other movement data. This information is provided exclusively for informational purposes.
...
We strongly caution against using the App while actively driving a vehicle. If the App must be used while driving, we recommend:
- Using a secure vehicle mount
- Setting up the App before beginning your journey
- Minimizing interaction with the App while in motion
- Following all applicable distracted driving laws
- Never entering data or manipulating the App's controls while operating a vehicle
...
Users bear sole responsibility for adhering to all traffic laws, speed limits, and safe driving practices regardless of information displayed by the App. The App is intended as a supplementary tool only and should never supersede official speed limits, traffic signs, or safe driving judgment.
...
We explicitly disclaim any liability for traffic violations, accidents, or other incidents that may occur during the use of the App. Users are solely responsible for driving safely and obeying traffic laws regardless of information provided by the App.
...
YOU AGREE THAT WE SHALL NOT BE LIABLE FOR ANY TRAFFIC VIOLATIONS, ACCIDENTS, OR OTHER INCIDENTS THAT MAY OCCUR DURING YOUR USE OF THE APP. YOU ARE SOLELY RESPONSIBLE FOR OBEYING ALL TRAFFIC LAWS AND DRIVING SAFELY.
...
WE ARE NOT LIABLE FOR ANY TRAFFIC VIOLATIONS, ACCIDENTS, OR OTHER INCIDENTS THAT MAY OCCUR DURING YOUR USE OF THE APP. YOU ARE SOLELY RESPONSIBLE FOR OBEYING ALL TRAFFIC LAWS AND DRIVING SAFELY.
...
SPECIAL PROVISIONS FOR SAFE DRIVING IN LATIN AMERICA
Users in Latin American countries acknowledge the unique traffic conditions and safety considerations in the region. The App should only be used in compliance with local traffic laws, which vary by country and municipality. The App is not a substitute for attentive driving and adherence to posted speed limits and traffic signals.
...
- Use the App in a manner that violates local traffic laws or regulations regarding vehicle usage and speed limits.
