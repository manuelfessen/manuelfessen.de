...
<Callout>Pro tip: Write them down and create hypotheses and deal with them as in science. If the hypothesis is right, it is good. If it is wrong, it is even better and we can look for the reason. </Callout>
